 ...
 * ============================================================================ */
    ...
    (function initCookieBanner() {
      try {
        if (localStorage.getItem('top10_cookie_consent')) return;
      } catch (e) { return; }
      ...
      const messages = {
        en: { text: 'We use cookies to enhance your experience and analyze traffic. By continuing, you agree to our', accept: 'Accept', linkText: 'Privacy Policy' },
        es: { text: 'Usamos cookies para mejorar tu experiencia y analizar el trafico. Al continuar, aceptas nuestra', accept: 'Aceptar', linkText: 'Politica de Privacidad' },
        fr: { text: 'Nous utilisons des cookies pour ameliorer votre experience et analyser le trafic. En continuant, vous acceptez notre', accept: 'Accepter', linkText: 'Politique de Confidentialite' },
        de: { text: 'Wir verwenden Cookies, um Ihre Erfahrung zu verbessern und den Datenverkehr zu analysieren. Mit der Nutzung stimmen Sie unserer', accept: 'Akzeptieren', linkText: 'Datenschutzerklarung' },
        it: { text: 'Utilizziamo i cookie per migliorare la tua esperienza e analizzare il traffico. Continuando, accetti la nostra', accept: 'Accetta', linkText: 'Privacy Policy' },
        pt: { text: 'Usamos cookies para melhorar sua experiencia e analisar o trafego. Ao continuar, voce concorda com nossa', accept: 'Aceitar', linkText: 'Politica de Privacidade' },
        ja: { text: 'User experience no kojo to traffic bunseki no tame Cookie wo shiyou shite imasu. Zokko suru koto de, tosha no', accept: 'Doui', linkText: 'Privacy Policy' },
        ko: { text: 'Gyeongheom gaeseon mich traffic bunseog-eul wihae cookie-reul sayonghabnida. Gyesoghamyeon dang-ui', accept: 'Surak', linkText: 'Gaein Jeongbo Cheoribeop' },
        hi: { text: 'Hum aapke anubhav ko behatar banane aur traffic ka vishleshan karne ke liye cookies ka upyog karte hain. Jari rakhkar, aap hamari', accept: 'Sveekar', linkText: 'Gopniyata Niti' },
        ar: { text: 'Nastakhdim mulaqat ta\'rif al-irtibat litahsin tajurbatak wa tahlil harakat al-murur. Min khilal al-mutaba\'a, fa-innaka tuwafiq \'ala', accept: 'Muwaafiq', linkText: 'Siyasat al-Khhususiyya' },
        id: { text: 'Kami menggunakan cookie untuk meningkatkan pengalaman Anda dan menganalisis lalu lintas. Dengan melanjutkan, Anda menyetujui', accept: 'Terima', linkText: 'Kebijakan Privasi' }
      };
      const msg = messages[baseLang] || messages.en;
      ...
      banner.innerHTML =
        '<p class="cookie-text">' + msg.text + ' <a href="/privacy-policy.html">' + msg.linkText + '</a></p>' +
        '<button class="cookie-accept" type="button">' + msg.accept + '</button>';
      ...
      acceptBtn.addEventListener('click', function() {
        try { localStorage.setItem('top10_cookie_consent', 'true'); } catch (e) {}
